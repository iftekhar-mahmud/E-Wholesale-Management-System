...
var cities = {
    'Dhaka': ['Dhaka', 'Gazipur', 'Narayanganj', 'Tangail', 'Mymensingh', 'Kishoreganj', 'Manikganj', 'Narsingdi', 'Munshiganj', 'Rajbari', 'Shariatpur', 'Gopalganj', 'Faridpur', 'Madaripur'],
    'Chattogram': ['Chattogram', 'Cox\'s Bazar', 'Feni', 'Khagrachhari', 'Rangamati', 'Bandarban', 'Brahmanbaria', 'Chandpur', 'Cumilla', 'Lakshmipur', 'Noakhali'],
    'Rajshahi': ['Rajshahi', 'Bogra', 'Naogaon', 'Natore', 'Chapai Nawabganj', 'Pabna', 'Joypurhat', 'Sirajganj'],
    'Khulna': ['Khulna', 'Jessore', 'Satkhira', 'Bagerhat', 'Chuadanga', 'Jhenaidah', 'Magura', 'Meherpur', 'Narail'],
    ...
    'Mymensingh': ['Netrokona', 'Mymensingh', 'Jamalpur', 'Sherpur']
  };
...
this.showCities=function(province,element){var str='<option selected disabled>Select City</option>';var elem='';if((province.indexOf(".")!==-1||province.indexOf("#")!==-1)){elem=province}
else{var cities = this.getCities(province); // Retrieve cities for the selected province
if (cities) {
