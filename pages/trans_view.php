...
function printContent() {
  ...
  style.textContent = `
    body {
      margin-top: 0px; /* Adjust as needed to crop out the top portion */
      margin-left: -100px; /* Adjust as needed to crop out the left portion */
      margin-bottom: -1000px;
    }
    header, nav {
      display: none; /* Hide header and navigation when printing */
    }
    button {
  ...
  document.head.appendChild(style); // Append the created style element to the document
